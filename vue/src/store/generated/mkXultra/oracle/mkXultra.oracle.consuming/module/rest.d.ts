 ...
 */
export declare type ConsumingParams = object;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/mkXultra/oracle/consuming/params
     */
    queryParams: (params?: RequestParams) => Promise<HttpResponse<ConsumingQueryParamsResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
