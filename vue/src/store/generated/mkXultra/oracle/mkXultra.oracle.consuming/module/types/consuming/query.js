...
export const protobufPackage = "mkXultra.oracle.consuming";
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("mkXultra.oracle.consuming.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    CoinRatesResult(request) {
        const data = QueryCoinRatesRequest.encode(request).finish();
        const promise = this.rpc.request("mkXultra.oracle.consuming.Query", "CoinRatesResult", data);
    ...
    LastCoinRatesId(request) {
        ...
        const promise = this.rpc.request("mkXultra.oracle.consuming.Query", "LastCoinRatesId", data);
